...
ploidyplot12 <- DimPlot(AT_root, group.by="ploidy.ID.P", cols=color, reduction = 'umap60', dims = c(1,2)) + labs(x = "", y = "", title = "Ploidy levels")
...
# Heatmap
pheatmap(cluster_matrix_norm, display_numbers = TRUE)
...
```{r}
new_cluster_ids <- c("Lateral/Columella Root Cap", "Lateral Root Cap", "Columella", "Trichoblast", "G2/M phase", "Stele", "Atrichoblast", "Epidermis", "Endodermis", "Cortex", "Stele", "Lateral/Columella Root Cap", "Epidermis/SC niche?", "(Lateral)Root Cap")
