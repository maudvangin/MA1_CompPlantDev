...
cluster_annot_scplant$clusterName <- recode(cluster_annot_scplant$clusterName, "c('Stem cell niche', 'Lateral root primordia') = 'Meristematic cell'")
```
...
```{r}
new_cluster_ids <- c("Lateral Root Cap", "Meristematic cell", "Columella Root Cap", "Trichoblast", "G2/M phase", "Stele", "Atrichoblast", "Epidermis/Atrichoblast", "Endodermis", "Cortex", "Stele", "Columella Root Cap", "Lateral Root Cap", "Lateral Root Cap")
